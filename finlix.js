...
<body>
    <div class="content">
        <h1>Welcome to LeapTheLimit AI</h1>
        <p>This is a test page to demonstrate the AI assistant widget.</p>
    </div>
    ...
    <div class="content">
        <h2>Sample Text</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ac ultrices nulla. Quisque vel risus vel ligula lacinia lacinia. Maecenas non dapibus est. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec vel dui nec leo volutpat bibendum. Cras in ante nunc.</p>
    </div>

    <div class="content">
        <h2>Sample Graph</h2>
        <img src="https://via.placeholder.com/400x300.png?text=Sample+Graph" alt="Sample Graph">
    </div>
